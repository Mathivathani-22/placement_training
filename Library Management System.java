...
static int current_user_index;
    public static void main(String[] args){
        ...
        System.out.flush();
        //------admins-------
        admin_mail_id.add("nmathivathani198@gmail.com");
        admin_password.add(220402);
        admin_mail_id.add("19cs085@kpriet.ac.in");
        admin_password.add(220402);
        //----learner--------
        learner_id.add(10000);
        learner_user_id.add("mathi22");
        learner_deposit.add(2000);
        learner_password.add(042202);
        //-----books---------
    ...
    public static void add_new_learner(){
        ...
        System.out.println("* Minimum deposit amount is Rs.2000");
