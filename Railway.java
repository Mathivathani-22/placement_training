...
public class Railway {
    ...
    private static final String train_num = "CS0B085";
    ...
    private static void admin() {
        ...
        if (admin_id == 22 && admin_pass == 2204) {
    ...
    private static void userList() {
        user_list.add(new users("moni", "2703", "9944999212", 10000, 93));
        user_list.add(new users("nandhu", "0107", "9976094979", 9000, 92));
        user_list.add(new users("Selci", "1403", "8098698037", 3000, 90));
    }
