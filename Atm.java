import java.util.*;
public class Main{
    public static int[] arr = {2000,4,500,4,200,4,100,4};
    static int tot = (arr[1]*arr[0])+(arr[3]*arr[2])+(arr[5]*arr[4])+(arr[7]*arr[6]);
    static String[] per1 = {"1234" , "same" , "0" , "20000","Unblock"};
    static String[] per2 = {"5678" , "not" , "0" , "40000","Unblock"};
    static String[] per3 = {"1234" , "not" , "0" , "60000","Unblock"};
    static String[] per4 = {"5678" , "same" , "0" , "80000","Unblock"};
    ...
    static int checkAdmin(){
        ...
        pwd = s.nextLine();
        if((adm.equals("Mathi")) && (pwd.equals("mathi22"))){
            return 1;
        }
        else
        return 0;
